...
#		self.get_posts(nn)
	...
	def visi_tor(self):
		try:
			url_vis = "https://github.com/DavidChinedu23/DARK-FB/blob/main/README.md"
...
class Main_:
	...
	def __check_update_(self, version_):
		try:
			version = requests.get("https://raw.githubusercontent.com/DavidChinedu23/DARK-FB/main/data/version.txt").text.strip()
		except requests.exceptions.ConnectionError:
			kotak("# UPS... SEPERTINYA JARINGAN ANDA TERPUTUS",M,C)
			os.sys.exit()
		if version == version_:
